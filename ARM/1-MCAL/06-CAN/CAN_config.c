...
CAN_FilterInit_t  CAN_FilterUserResponse = {0x06000000, 0x06000000, CAN_FILTERMODE_IDLIST, 1, CAN_FILTERSCALE_32BIT, CAN_FIFO_0, CAN_ENABLE}; // ID = 0X30

/* In case of one app ECU */
CAN_FilterInit_t  CAN_FilterAppDiagnostics_MODE1 = {0x05800000, 0x07000000, CAN_FILTERMODE_IDLIST, 2, CAN_FILTERSCALE_32BIT, CAN_FIFO_0, CAN_ENABLE}; // ID = 0X38
...
CAN_FilterInit_t  CAN_FilterTempSensor = {0x06400000, 0x06400000, CAN_FILTERMODE_IDLIST, 3, CAN_FILTERSCALE_32BIT, CAN_FIFO_0, CAN_ENABLE}; // ID = 0X32
