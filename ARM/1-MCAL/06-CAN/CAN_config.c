...
CAN_FilterInit_t CAN_FilterApp1Diagnostics = {(u32)(0X47<<21), (u32)(0X47<<21), CAN_FILTERMODE_IDLIST, 5, CAN_FILTERSCALE_32BIT, CAN_FIFO_0, CAN_ENABLE};

CAN_FilterInit_t CAN_FilterApp2Diagnostics = {(u32)(0X48<<21), (u32)(0X48<<21), CAN_FILTERMODE_IDLIST, 6, CAN_FILTERSCALE_32BIT, CAN_FIFO_0, CAN_ENABLE};
