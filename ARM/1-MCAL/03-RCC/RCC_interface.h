...
//Function to initialize RCC peripheral and provide clock for all needed peripherals
void RCC_voidInit (void);

//Function to Disable clock from specific peripheral
u8 RCC_u8DisableClock(u8 Copy_u8PeripheralID);

//Function to change bus mode (return value is error state)
