...
void WWDG_voidReset(u8 Copy_u8TimeoutValue)
{
	...
	{
		case WWDG_DIVIDE_BY_1:CLR_BIT(WWDG->CFR,WWDG_CFR_WDGTB1);CLR_BIT(WWDG_CFR,WWDG_CFR_WDGTB0);break;
		case WWDG_DIVIDE_BY_2:CLR_BIT(WWDG->CFR,WWDG_CFR_WDGTB1);SET_BIT(WWDG_CFR,WWDG_CFR_WDGTB0);break;
		case WWDG_DIVIDE_BY_4:SET_BIT(WWDG->CFR,WWDG_CFR_WDGTB1);CLR_BIT(WWDG_CFR,WWDG_CFR_WDGTB0);break;
		case WWDG_DIVIDE_BY_8:SET_BIT(WWDG->CFR,WWDG_CFR_WDGTB1);SET_BIT(WWDG_CFR,WWDG_CFR_WDGTB0);break;
	}
