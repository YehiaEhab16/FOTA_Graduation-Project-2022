...
int main(void)
{
	...
	extern TaskHandle_t Global_TaskHandle_tAlert, Global_TaskHandle_tDist, Global_TaskHandle_tSend;
	...
	xTaskCreate((TaskFunction_t)Task_voidSystemCheck,     "Task8", configMINIMAL_STACK_SIZE, NULL, 3, NULL);
	xTaskCreate((TaskFunction_t)Task_voidSendDiagnostics, "Task9", configMINIMAL_STACK_SIZE, NULL, 3, &Global_TaskHandle_tSend);
